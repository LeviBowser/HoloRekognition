...
![Unity Build](/images/unity build checkbox.png?raw=true)
    1. Click *Install*
...
![XR Settings](/images/xr-settings.png?raw=true?raw=true)
...
![Visual Studio Build](/images/visual-studio-build-button.png?raw=true)
